...
if ($_SESSION["role"] != 'driver') {
    $_SESSION['error_message'] = "You do not have permission to access Driver Interface.";
    header("location: " . BASE_URL . "dashboard.php");
    exit;
}

$page_title = "Shipment Status Update";
$current_page = "driver";
...
$shipments = [];
        ...
        WHERE d.user_id = ? AND s.status IN ('in_transit', 'out_for_delivery')
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_status'])) {
        ...
        if (!in_array($new_status, $valid_statuses)) {
            ...
            try {
                ...
                $actual_arrival = ($new_status == 'delivered') ? date('Y-m-d H:i:s') : NULL;
                updateShipmentStatus($shipment_id, $new_status, $_SESSION['user_id'], NULL, $actual_arrival, $damage_notes);
                
                $_SESSION['success_message'] = "Shipment status updated successfully to: " . ucfirst($new_status);
                
            } catch (Exception $e) {
                $_SESSION['error_message'] = "Transaction failed: " . $e->getMessage();
                error_log("Driver shipment status update failed: " . $e->getMessage());
            }
            
            // Redirect to refresh the page
            header("location: " . BASE_URL . "driver/shipment_status.php");
            exit;
        }
    }
...
<div class="content">
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-truck me-2"></i>Shipment Status Update</h2>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h5 class="card-title mb-1">
                                    <i class="fas fa-user-tie me-2"></i>Driver Dashboard
                                </h5>
                                <p class="card-text mb-0">
                                    Welcome back, <?php echo htmlspecialchars($_SESSION['username']); ?>! 
                                    You have <?php echo count($shipments); ?> active shipments to manage.
                                </p>
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-xl-4 mb-4">
                <div class="card h-100 border-<?php echo $shipment['status'] == 'out_for_delivery' ? 'warning' : 'info'; ?>">
                    <div class="card-header bg-<?php echo $shipment['status'] == 'out_for_delivery' ? 'warning' : 'info'; ?> text-white">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <button class="btn btn-primary w-100 mb-2" 
                                    onclick="showStatusUpdateModal(<?php echo $shipment['shipment_id']; ?>, '<?php echo htmlspecialchars($shipment['customer_name']); ?>')">
        ...
        <div class="text-center py-5">
            ...
            <p class="text-muted">You don't have any shipments assigned at the moment.</p>
        </div>
        <?php endif; ?>
    </div>
</div>
            ...
            <form method="POST" action="">
                <div class="modal-body">
                    ...
                    <div class="mb-3" id="damageNotesDiv" style="display: none;">
                        <label for="damage_notes" class="form-label">Damage Notes</label>
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Note:</strong> Updating the status will automatically update the inventory and order status.
                    </div>
                </div>
...
<script>
function showStatusUpdateModal(shipmentId, customerName) {
